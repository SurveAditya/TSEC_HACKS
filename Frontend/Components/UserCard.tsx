...
const UserCard = ({ userImage, userName, userEmail, postCount }: Props) => {
  ...
  return (
    <div className=" md:p-6 lg:p-1 flex flex-col max-w-full dark:bg-gray-900 dark:text-white">
      ...
      <div className="w-full max-w-sm min-w-full sm:min-w-[300px] md:min-w-[400px] bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
